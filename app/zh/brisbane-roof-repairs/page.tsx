...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "布里斯班屋顶维修中文服务",
    description:
      "根据漏水位置、屋顶材料、损坏范围和现场条件，判断需要检查或维修的部分。",
  },
};
...
const advantages = [
  ...
  {
    title: "正在漏水，先确认安全和检查安排",
    copy: "如果正在进水或刚发生风暴损坏，请先打电话说明水进入的位置、是否有电气风险和所在 suburb。团队会核对天气、安全通道与人员安排，再确认是否能够到场检查。",
  },
  {
    title: "符合条件的施工有工艺质保",
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "团队会先了解漏水位置、屋顶材料、进水时间和现场条件，再判断是否需要临时保护、现场检查或局部维修。网站也展示真实项目照片，方便您了解以往工作的实际情况。",
  },
  {
    ...
    <PageShell>
      <article lang="zh-Hans-AU">
        ...
        <PageHero
          ...
          title="布里斯班屋顶维修中文服务"
          description="屋顶漏水、裂瓦或缺瓦、金属屋顶渗漏与锈蚀、风暴损坏和紧急问题，需要不同的检查与维修。请说明水痕或损坏的位置、出现时间、屋顶材料和所在 suburb，以便讨论检查范围。"
